...
<div class="profile-hero">
  <img class="hero-photo" src="/assets/ken-profile.jpg" alt="Kenneth Vallespin" />
  <div class="hero-text">
    <h1>Kenneth Vallespin <span>(Ken)</span></h1>
    <p class="credentials">EUR ING · PE · CEng · MIET · MRAeS · PMP · PRINCE2 · PECE · ASEAN Eng. · ACPE · APEC Eng. · SCE Consultant · LSSBB</p>
  </div>
</div>
...
I stay connected to the global engineering community through active membership in the Royal Aeronautical Society (RAeS) and the Institution of Engineering and Technology (IET).
